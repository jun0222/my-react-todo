...
export const AddForm = (props) => {
    ...
    return (
        <div className="add-style">
            <form action="">
                <input className="add-input-style" type="text" value={taskTitleText} onChange={onChangeTaskTitleText} maxLength='10' placeholder="タイトルを入力" />
                ...
                <input className="add-input-detail-style" type="text" value={taskDetailText} onChange={onChangeTaskDetailText} maxLength='50' placeholder="タスクの詳細を入力" />
